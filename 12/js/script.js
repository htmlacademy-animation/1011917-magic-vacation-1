...
/* harmony import */ var _smil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./smil */ "./source/js/modules/smil.js");
/* harmony import */ var _timer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./timer.js */ "./source/js/modules/timer.js");
/* harmony import */ var _prizes_counter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./prizes-counter.js */ "./source/js/modules/prizes-counter.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (isPrizesScreenActive) {
      ...
      Object(_timer_js__WEBPACK_IMPORTED_MODULE_3__["resetTimer"])();

      setTimeout(() => {
        this.showScreen(this.screenElements[this.activeScreen]);
      }, 650);
      setTimeout(() => {
        Object(_smil__WEBPACK_IMPORTED_MODULE_2__["default"])(this.screenElements[this.activeScreen].id);
      }, 1200);

      setTimeout(() => {
        // prizes counter starter
        Object(_prizes_counter_js__WEBPACK_IMPORTED_MODULE_4__["runCounters"])();
      }, 2000);
      ...
      Object(_timer_js__WEBPACK_IMPORTED_MODULE_3__["resetTimer"])();
      Object(_prizes_counter_js__WEBPACK_IMPORTED_MODULE_4__["resetCounters"])();
      ...
      Object(_timer_js__WEBPACK_IMPORTED_MODULE_3__["runTimer"])();
      Object(_prizes_counter_js__WEBPACK_IMPORTED_MODULE_4__["resetCounters"])();
  ...
  handleAnimations() {
    ...
    if (this.activeScreen === 1) {
      setTimeout(() => _intro__WEBPACK_IMPORTED_MODULE_1__["StoryTitleAccentTypography"].runAnimation(), 300);
    } else {
      _intro__WEBPACK_IMPORTED_MODULE_1__["StoryTitleAccentTypography"].destroyAnimation();
    }

    if (this.activeScreen === 2) {
      setTimeout(() => _intro__WEBPACK_IMPORTED_MODULE_1__["PrizesTitleAccentTypography"].runAnimation(), 700);
    } else {
      _intro__WEBPACK_IMPORTED_MODULE_1__["PrizesTitleAccentTypography"].destroyAnimation();
    }

    if (this.activeScreen === 3) {
      setTimeout(() => _intro__WEBPACK_IMPORTED_MODULE_1__["RulesTitleAccentTypography"].runAnimation(), 300);
    } else {
      _intro__WEBPACK_IMPORTED_MODULE_1__["RulesTitleAccentTypography"].destroyAnimation();
    }

    if (this.activeScreen === 4) {
      setTimeout(() => _intro__WEBPACK_IMPORTED_MODULE_1__["GameTitleAccentTypography"].runAnimation(), 500);
    } else {
      _intro__WEBPACK_IMPORTED_MODULE_1__["GameTitleAccentTypography"].destroyAnimation();
    }
  }
}
...
/*!************************************!*\
  !*** ./source/js/modules/intro.js ***!
  \************************************/
/*! exports provided: TitleAccentTypography, DateAccentTypography, PrizesTitleAccentTypography, StoryTitleAccentTypography, RulesTitleAccentTypography, GameTitleAccentTypography */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrizesTitleAccentTypography", function() { return PrizesTitleAccentTypography; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StoryTitleAccentTypography", function() { return StoryTitleAccentTypography; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RulesTitleAccentTypography", function() { return RulesTitleAccentTypography; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GameTitleAccentTypography", function() { return GameTitleAccentTypography; });
...
const PrizesTitleAccentTypography = new _accent_typography__WEBPACK_IMPORTED_MODULE_0__["default"](
    PrizesTitle,
    600,
    {min: 0, max: 150},
    `active`,
...
const StoryTitleAccentTypography = new _accent_typography__WEBPACK_IMPORTED_MODULE_0__["default"](
    StoryTitle,
    400,
    {min: 0, max: 150},
    `active`,
...
const RulesTitleAccentTypography = new _accent_typography__WEBPACK_IMPORTED_MODULE_0__["default"](
    RulesTitle,
    400,
    {min: 0, max: 150},
    `active`,
...
const GameTitleAccentTypography = new _accent_typography__WEBPACK_IMPORTED_MODULE_0__["default"](
    GameTitle,
    400,
    {min: 0, max: 150},
    `active`,
