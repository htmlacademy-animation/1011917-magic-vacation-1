...
import Scene0Story from './storyScene0.js';
import Scene1Story from './storyScene1.js';
import Scene2Story from './storyScene2.js';
import Scene3Story from './storyScene3.js';

class StorySceneConstructor extends THREE.Group {
  constructor() {
    super();
...
export default StorySceneConstructor;
